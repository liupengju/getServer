...
xmlAnalysisThread::xmlAnalysisThread(const QStringList &sFileList)
{
    fileList = sFileList;
    xlsObj = new xlsAxObj();
}

xmlAnalysisThread::~xmlAnalysisThread()
{
    delete xlsObj;
}
void xmlAnalysisThread::run()
{
    while(1)
    {
...
void xmlAnalysisThread::getSerInfoFromxls(QXmlStreamWriter &xml,QString fileName)
{
